...
export const landzSlice = createSlice({
  name: "landz",
  initialState: {},
  reducers: {
...
export const { replaceAll, setLandz, setHasFetched, setIsLoading, updateItem } =
  landzSlice.actions;

export default landzSlice.reducer;
