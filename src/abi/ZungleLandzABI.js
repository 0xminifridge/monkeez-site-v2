export const ZUNGLE_LANDZ_ABI = [
  {
    inputs: [
      { internalType: "bytes32", name: "_root_one", type: "bytes32" },
      { internalType: "bytes32", name: "_root_two", type: "bytes32" },
    ],
  ...
  },
  {
    ...
    name: "mintState",
    outputs: [
      { internalType: "enum ZungleLandz.MintState", name: "", type: "uint8" },
    ],
    stateMutability: "view",
    type: "function",
  },
