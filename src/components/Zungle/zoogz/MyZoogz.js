  ...
  return (
    <div class="p-1 sm:py-5 justify-center flex">
      <div class="flex flex-col">
        ...
        {data?.length > 0 ? (
          <div class="order-0 pt-2 mb-2 grid auto-cols-max grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 overflow-scroll h-[75vh] gap-4 m-auto">
            {data?.map((item, index) => {
