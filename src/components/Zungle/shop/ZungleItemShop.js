  ...
  return (
    <div class="px-1 sm:py-5 justify-center flex">
      <div class="flex flex-col">
        ...
        <div class="py-2 mb-2 grid auto-cols-max auto-rows-max grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 overflow-scroll h-[75vh] gap-4 m-auto border-0 border-b-4 border-t-4 border-black border-solid">
